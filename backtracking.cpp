  ...
  for(int l = 0; l < n; l++){
    ...
    for(int cantElementos = 1; cantElementos <= n; cantElementos++){
      ...
      for(int i = l; i < n; i++){
        ...
        // PODA: NO AGREGAR EL PAQUETE SI YA SE QUE SE PASA DE LA CAPACIDAD DE LA MOCHILA. 
        //        ADEMAS ME EVITO PROBAR TODAS LAS COMBINACIONES DE ESE PAQUETE.
        if(pesoAcumulado + pesos[i] < w){   
